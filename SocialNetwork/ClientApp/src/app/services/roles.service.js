...
const UpdateUserRoles_1 = require("../models/UpdateUserRoles");
let RolesService = class RolesService {
    ...
    updateUserRoles(id, roles) {
        var updateUserRoles = new UpdateUserRoles_1.UpdateUserRoles();
        updateUserRoles.RolesToAssign = roles;
        return this.http.put(this.url + 'api/roles/' + id, updateUserRoles);
    }
};
